package xiaomage.dynamicPlanning;

/**
 * @description: 最长公共子序列 (Longest Common Subsequence) 不需要连续
 * <p>
 * https://leetcode-cn.com/problems/longest-common-subsequence/
 * @author: xwy
 * @create: 10:14 AM 2020/8/25
 **/
...
public class LCS {
    ...
    /**
     * 优化 4 : 使用一维数组 (使用 length 较小的为一维数组)
     *
     * @param nums1
     * @param nums2
     * @return
    ...
    /**
     * 求 nums1 前 i 个元素和 nums2 前 j 个元素的最长公共子序列长度 (动态规划)
     * <p>
     * 和 斐波那契数列一样,会有很多重复计算
     * <p>
     * 递归实现
